            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground font-medium">
                  AI-Powered Audio to Text Service
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              {apiKey && (
                <div className="flex items-center gap-3 px-4 py-2 bg-success/10 text-success rounded-full border border-success/20 shadow-professional">
                  ...
                  <span className="hidden sm:inline font-medium">API Ready</span>
                </div>
              )}
              <ThemeToggle />
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground space-y-1">
                      <p>• Powered by OpenAI Whisper for audio-to-text conversion</p>
                      <p>• Enhanced and refined by Google Gemini AI processing</p>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center space-y-4">
            <div className="flex justify-center items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg">Professional Transcriber</span>
            </div>
            <p className="text-muted-foreground">
              Powered by{" "}
              <span className="font-semibold text-primary">OpenAI Whisper</span>
              {" + "}
              <span className="font-semibold text-primary">Google Gemini</span>
              {" • "}
              Built for{" "}
